...
INSERT INTO MEMBER (mID, mPW, mNAME, mTEL, mEMAIL, mGENDER, mBIRTH, mADDRESS)
    VALUES ('ttt', '1', '자바', '010-5533-2222', 'km@km.com', 'w','1999-11-11', '부산');
...
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (BOARD_SEQ.NEXTVAL, 'ggg', '글7', '이글의내용', NULL, BOARD_SEQ.CURRVAL, 0, 0, '192.000.1.0');
-- 4. hit 1회 올리기
...
-- 9. 답변글 쓰기
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (BOARD_SEQ.NEXTVAL, 'aaa', '글8', '글의내용', NULL, 1, 0, 0, '192.0.1.0');
COMMIT;
