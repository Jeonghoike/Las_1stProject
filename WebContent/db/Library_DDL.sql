...
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (FILEBOARD_SEQ.NEXTVAL, 'aaa', '글1', '냉무', NULL, FILEBOARD_SEQ.CURRVAL, 0, 0, '192.168.5.4');
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (FILEBOARD_SEQ.NEXTVAL, 'bbb', '글2', '본문', NULL, FILEBOARD_SEQ.CURRVAL, 0, 0, '192.000.5.4');
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (FILEBOARD_SEQ.NEXTVAL, 'ccc', '글3', '컨텐츠', NULL, FILEBOARD_SEQ.CURRVAL, 0, 0, '192.168.5');
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (FILEBOARD_SEQ.NEXTVAL, 'ddd', '글4', '내용', NULL, FILEBOARD_SEQ.CURRVAL, 0, 0, '192.100.0.4');
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (FILEBOARD_SEQ.NEXTVAL, 'eee', '글5', '없음', NULL, FILEBOARD_SEQ.CURRVAL, 0, 0, '192.158.2.4');
INSERT INTO FILEBOARD (fID, mID, fTITLE, fCONTENT, fFILENAME, fGROUP, fSTEP, fINDENT, fIP)
    VALUES (FILEBOARD_SEQ.NEXTVAL, 'fff', '글6', '몰라', NULL, FILEBOARD_SEQ.CURRVAL, 0, 0, '192.108.1.0');
