...
<body>
	...
	<form action="${conPath }/boradModify.do" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<th>작성자</th>
				<td><input type="text" required="required" value="${board.mname }(${board.mid })" readonly="readonly"></td>
			</tr>
			<tr>
				<th>제목</th>
				<td><input type="text" name="ftitle" required="required" value="${board.ftitle }"></td>
			</tr>
			<tr>
				<th>본문</th>
